<script lang="ts">
  ...
  const headerUrl = "/bms/table/self-dp/header.json";
...
<svelte:head>
  <meta name="bmstable" content={$page.url.origin + "/bms/table/self-dp/header.json"} />
</svelte:head>
...
<BreadcrumbNav
  items={breadcrumbs}
  sessionKey="breadcrumb-bms-table-self-dp"
  initiallyOpen={false}
/>
<div
